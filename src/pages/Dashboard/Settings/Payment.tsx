...
const Payment: React.FC<Props> = ({ onTabChange }) => {
  ...
  const [refundPolicy, setRefundPolicy] = useState<RefundPolicy>("immediate");
    ...
    <Box sx={{ p: 3, bgcolor: "#f6f8fb", minHeight: "100vh" }}>
      ...
      <Paper sx={{ p: 3, mb: 3 }}>
        <Box display="flex" justifyContent="space-between" mb={2}>
          <Typography fontWeight={600}>Payment Gateway Configuration</Typography>
          <Button
            variant="contained"
            startIcon={<AddIcon />}
      ...
      <Paper sx={{ p: 3 }}>
        ...
        <Box sx={{ display: "flex", flexWrap: "wrap", gap: 3 }}>
          <Box sx={{ flex: "1 1 300px" }}>
            ...
            <TextField fullWidth defaultValue={15} />
          </Box>
